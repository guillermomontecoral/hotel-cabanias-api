...
namespace Hotel.LogicaAccesoDatos.Migrations
{
    ...
    [Migration("20230605165841_IndexNombre_TipoCabanha")]
    partial class IndexNombre_TipoCabanha
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogicaNegocio.Entidades.TipoCabanha", b =>
                {
                    ...
                    b.OwnsOne("Hotel.LogicaNegocio.Entidades.ValueObjects.TipoCabanha.DescripcionCabanha", "Descripcion", b1 =>
                        {
                    ...
                    b.OwnsOne("Hotel.LogicaNegocio.Entidades.ValueObjects.TipoCabanha.NombreCabanha", "Nombre", b1 =>
                        {
                            b1.Property<int>("CabanhaId")
                                .HasColumnType("int");
